...
app = FastAPI(
    ...
    description=(
        "RAG-based chatbot API for Near Partner knowledge base. "
        "AI transparency notice (EU AI Act Art. 50): every response from /api/v1/chat "
        "is generated by an AI system (local LLM), not a human, and may be inaccurate. "
        "Clients embedding this API in a user-facing product must disclose this to end users. "
        "See PRIVACY.md and docs/ai-system-card.md for data handling and system limitations."
    ),
    version="1.0.0"
)
